...
Thie is a response to [Daniel Litt's](https://twitter.com/littmath/status/1648315697791942658) challenge to explain the concept of **short exact sequences** at an elementary level. 
...
- Physical displacements in one dimension. We can add and subtract physical displacements like so:
  ...
  One reason for the abstract language of abelian groups, rather than just talking about normal addition of numbers, is so that we can describe the _intrinsic_ properties of these examples without making an arbitrary choice of units. It provides 
...
Technical point: it's slightly better to write 360Z and 10Z rather than Z here.